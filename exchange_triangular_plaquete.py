...
for i in range(N_sites):
    ...
    NN2.append((i,(i+3)%N_sites))
    NN3.append((i,(i+4)%N_sites))
...
plt.title(" %d Number of sites for $J_\perp$=%f" %(N_sites,J_perp))
plt.subplot(212)
...
plt.savefig("Energy_Jperp=%f_Ns%d.png" %(J_perp,N_sites))
